...
const ADAPTER_SEARCH_FIELDS = ['id', 'english_names', 'turkish_names', 'category'] as const;
...
export async function POST(req: Request) {
  ...
  try {
    ...
    const result = await client.query(
      'INSERT INTO public.adapters (id, english_names, turkish_names, category, quantity, price, image_filename, description) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING id',
