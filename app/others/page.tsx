...
import { fetchOtherProducts, type OtherPagination } from "@/lib/services/others";
import { OtherInventoryClient } from "@/components/others/others-inventory-client";
...
export default async function OtherPage({
  ...
  let responseData: OtherPagination | null = null;
  ...
  try {
    responseData = await fetchOtherProducts(apiBaseUrl, currentPage, query, field);
  } catch (error) {
    console.error("[others/page] fetch error:", error);
    return notFound();
  }
