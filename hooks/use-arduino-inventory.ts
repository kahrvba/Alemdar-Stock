  ...
  useEffect(() => {
    if (editingProduct) {
      setFormState({
        ...
        category_layer_1: editingProduct.category_layer_1 ?? "",
        category_layer_2: editingProduct.category_layer_2 ?? "",
    ...
    try {
      ...
      const response = await fetch("/api/arduino", {
        ...
        body: JSON.stringify({
          ...
          category_layer_1: formState.category_layer_1 || null,
          category_layer_2: formState.category_layer_2 || null,
