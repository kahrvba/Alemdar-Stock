...
export function TvRemoteSearch({
  onFilterChange,
  onLoadingChange,
}: TvRemoteSearchProps = {}) {
  ...
  useEffect(() => {
    ...
    searchParamsSnapshot.current = currentUrl;
    stopLoadingIndicator();
  }, [searchParams, decodeSearchParam, field, query, stopLoadingIndicator, useFieldFilter]);
  ...
  const handleFieldSelection = useCallback((nextField: FilterOption | null) => {
