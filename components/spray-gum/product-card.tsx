...
import { SprayGumProduct } from "@/lib/services/spray-gum";
...
type ProductCardProps = {
  product: SprayGumProduct;
  onEdit?: (product: SprayGumProduct) => void;
  onDelete?: (product: SprayGumProduct) => void;
  onAddToCart?: (product: SprayGumProduct) => void;
  onSend?: (product: SprayGumProduct) => void;
  isDeleting?: boolean;
  isSelected?: boolean;
        ...
        {product.image_filename ? (
          <HoverZoom className="relative h-full w-full">
            <Image
              ...
              alt={product.english_name ?? "Cable product"}
              fill
