...
import { ScrawesdriverProduct } from "@/lib/services/scrawesdriver";
...
type ProductCardProps = {
  product: ScrawesdriverProduct;
  onEdit?: (product: ScrawesdriverProduct) => void;
  onDelete?: (product: ScrawesdriverProduct) => void;
  onAddToCart?: (product: ScrawesdriverProduct) => void;
  isDeleting?: boolean;
        ...
        {product.image_filename ? (
          <HoverZoom className="relative h-full w-full">
            <Image
              ...
              alt={product.english_names ?? "Scrawesdriver product"}
              fill
