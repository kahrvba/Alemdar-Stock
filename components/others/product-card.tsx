...
import { OtherProduct } from "@/lib/services/others";
import { HoverZoom } from "@/components/ui/hover-zoom";
import { cn } from "@/lib/utils";

type ProductCardProps = {
  product: OtherProduct;
  onEdit?: (product: OtherProduct) => void;
  onDelete?: (product: OtherProduct) => void;
  onAddToCart?: (product: OtherProduct) => void;
  isDeleting?: boolean;
        ...
        {product.image_filename ? (
          <HoverZoom className="relative h-full w-full">
            <Image
              ...
              alt={product.english_names ?? "Other product"}
              fill
