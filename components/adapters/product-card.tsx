...
import { AdapterProduct } from "@/lib/services/adapters";
...
type ProductCardProps = {
  ...
  onEdit?: (product: AdapterProduct) => void;
  onDelete?: (product: AdapterProduct) => void;
  onAddToCart?: (product: AdapterProduct) => void;
  isDeleting?: boolean;
        ...
        {product.image_filename ? (
          <HoverZoom className="relative h-full w-full">
            <Image
              ...
              alt={product.english_names ?? "Adapter product"}
              fill
