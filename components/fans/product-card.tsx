...
import { FanProduct } from "@/lib/services/fans";
import { HoverZoom } from "@/components/ui/hover-zoom";
import { cn } from "@/lib/utils";

type ProductCardProps = {
  product: FanProduct;
  onEdit?: (product: FanProduct) => void;
  onDelete?: (product: FanProduct) => void;
  onAddToCart?: (product: FanProduct) => void;
  isDeleting?: boolean;
        ...
        {product.image_filename ? (
          <HoverZoom className="relative h-full w-full">
            <Image
              ...
              alt={product.english_names ?? "Fan product"}
              fill
