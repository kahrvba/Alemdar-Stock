...
import { LampProduct } from "@/lib/services/lamps";
...
type ProductCardProps = {
  product: LampProduct;
  onEdit?: (product: LampProduct) => void;
  onDelete?: (product: LampProduct) => void;
  onAddToCart?: (product: LampProduct) => void;
  isDeleting?: boolean;
        ...
        {product.image_filename ? (
          <HoverZoom className="relative h-full w-full">
            <Image
              ...
              alt={product.english_names ?? "Lamp product"}
              fill
