...
import { ElectricProduct } from "@/lib/services/electric";
...
type ProductCardProps = {
  ...
  onEdit?: (product: ElectricProduct) => void;
  onDelete?: (product: ElectricProduct) => void;
  onAddToCart?: (product: ElectricProduct) => void;
  isDeleting?: boolean;
    ...
    >
        ...
        {product.image_filename ? (
          <HoverZoom className="relative h-full w-full">
            <Image
              ...
              alt={product.english_names ?? "Electric product"}
              fill
      ...
      <div className="flex flex-1 flex-col gap-4 p-6">
        ...
        <div className="mt-auto flex flex-col gap-3 text-sm text-muted-foreground">
          <div className="grid grid-cols-2 items-center gap-3 min-w-0">
